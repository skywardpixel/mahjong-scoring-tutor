...
import { lessons, getLessonById, getNextLesson, getPreviousLesson } from '../lessonData'
...
describe('lessonData', () => {
  ...
  describe('Educational content validation', () => {
    it('should have correct quiz answers for key lessons', () => {
      ...
      expect(lesson1.quiz.correct).toBe(0) // "30 fu"
      expect(lesson1.quiz.options[0]).toBe("30 fu")
      
      // Lesson 6: Scoring formula
      const lesson6 = getLessonById(6)
      expect(lesson6.quiz.correct).toBe(0) // "120 points"
      expect(lesson6.quiz.options[0]).toBe("120 points")
    })
