...
describe('App Integration', () => {
  ...
  it('should persist current lesson in localStorage', () => {
    ...
    expect(mockLocalStorage.getItem).toHaveBeenCalledWith('mahjong-current-lesson')
    expect(mockLocalStorage.getItem).toHaveBeenCalledWith('mahjong-completed-lessons')
  })
