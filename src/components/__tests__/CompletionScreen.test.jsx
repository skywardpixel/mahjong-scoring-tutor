...
describe('CompletionScreen', () => {
  ...
  it('should render congratulations message', () => {
    render(<CompletionScreen onRestart={mockOnRestart} onPractice={mockOnPractice} />)
    
    expect(screen.getByText('Congratulations!')).toBeInTheDocument()
    expect(screen.getByText("You've completed all 16 lessons!")).toBeInTheDocument()
  })
  ...
  it('should display skills learned list', () => {
    ...
    expect(screen.getByText(/Fu calculation and rounding rules/)).toBeInTheDocument()
    expect(screen.getByText(/Han system and yaku recognition/)).toBeInTheDocument()
  ...
  it('should display next steps section', () => {
    ...
    expect(screen.getByText(/fundamental principles of Japanese Mahjong scoring/)).toBeInTheDocument()
    expect(screen.getByText(/Majsoul use standardized payment tables/)).toBeInTheDocument()
  })
  ...
  it('should have proper CSS classes for styling', () => {
    const { container } = render(<CompletionScreen onRestart={mockOnRestart} onPractice={mockOnPractice} />)
  ...
  it('should display all skill items', () => {
    ...
    const skillItems = screen.getByText(/Fu calculation/).closest('ul').querySelectorAll('li')
